...
//
$.each($(".bloggerologi-view[data-id]"),function(c,f){var b=$(f).parent().find("#bview").addClass("onloadologi"),d=new Firebase("https://lsfsophia.firebaseio.com/pages/id/"+$(f).attr("data-id"));d.once("value",function(e){var h=e.val(),g=!1;null==h&&(h={},h.value=0,h.url=window.location.href,h.id=$(f).attr("data-id"),g=!0),b.removeClass("onloadologi").text(h.value),h.value++,"/"!=window.location.pathname&&(g?d.set(h):d.child("value").set(h.value))})});$(document).ready(function(){$('img').each(function(){var $img=$(this);var filename=$img.attr('src')
